declare type MessageCategory = 'error' | 'warning' | 'info' | 'log' | 'debug';
...
export { MessageCategory, ITSMessage, IFileInfo, IFileMessages, IFileStats, IMap, IProject, IProjectResults };
